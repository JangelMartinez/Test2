...
const Mode = () => {
  ...
  return (
	  ...
	  <div className="mt-4">
	  { 
	  	!state.dark ? <button id="bdark" className=' btn btn-dark rounded-circle' onClick={()=>{mdark()}}><FaMoon /></button> : <button id="bdark" className=' btn btn-light rounded-circle' onClick={()=>{mdark()}}><FaSun /></button>
	  }
	  </div>
